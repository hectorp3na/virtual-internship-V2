...
export default function ChoosePlanPage() {
  return (
    <div className="wrapper wrapper__full">
      <div className="sidebar__overlay_overlay--hidden"></div>
      <div className="plan">
          ...
          <div className="container">
            ...
            <div className="plan__card--cta">
              ...
              <div className="plan__disclaimer">
                Cancel your trial at any time before it end, and you won't be
                charged.
              </div>
            </div>
            <div className="faq__wrapper">
              <div className="accordian__card">
                ...
                <div className="collapse show" style={{ height: "120px" }}>
                  <div className="accordian__body">
                    ...
                    trial period expires. With Premium access, you can learn at
                    your own pace and as frequently as you desire, and you may
              ...
              <div className="accordian__card">
                <div className="accordian__header">
                  <div className="accordian__title">
                    Can I switch subscription from monthly to yearly, or yearly
                    to monthly?
                  </div>
                  <svg
                    stroke="currentColor"
                ...
                <div className="collapse" style={{ height: "0px" }}>
                  <div className="accordian__body">
                    ...
                    ends, transitioning from a monthly plan to an annual plan is
                    an option."
                  </div>
                </div>
              </div>
              ...
              <div className="accordian__card">
                <div className="accordian__header">
                  <div className="accordian__title">
                    CAn I cancel during my trial or subscripton?
                  </div>
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
